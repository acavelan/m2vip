...
int main(int argc, char **argv)
{
	...
	cudaMallocHost((void**)&d_pixels, size * 3 * sizeof(unsigned char), cudaHostAllocMapped);
	memcpy(d_pixels, ILpixels, size * 3 * sizeof(unsigned char));
